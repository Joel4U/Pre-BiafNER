...
class TransformersEmbedder(nn.Module):
    ...
    def __init__(self, transformer_model_name: str, is_freezing: bool = False):
        ...
        self.model = AutoModel.from_pretrained(transformer_model_name,
                                               ...
                                               return_dict=True)
        # self.model = BertModel.from_pretrained(transformer_model_name)
        # self.model = AutoModel.from_pretrained(transformer_model_name,  output_hidden_states= output_hidden_states,
        #                                 return_dict=True)
        """
