...
class Config:
    def __init__(self, args) -> None:
        ...
        self.affine_outputsize = args.affine_outputsize
        self.context_outputsize = args.context_outputsize
        self.activation = args.activation
        self.num_layers = 1
        self.num_gcn_layers = 2  # "number of gcn layers"
        ...
        self.is_freezing = args.is_freezing
